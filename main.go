...
func getOptions() (Options, error) {
	...
	json := flag.Bool("json", false, "Output the release pull request data in JSON format.")
...
func run(options Options) error {
	...
	data, err := RenderTemplate(options.template, RenderTemplateData{pullRequests, date}, options.disableGeneratedByMessage)
